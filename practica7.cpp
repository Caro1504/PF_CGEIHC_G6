...
//PROYECTO FINAL: PARQUE NAUCALLI CON SLENDERMAN Y JACK SKELLINGTON
...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		//Modelo Zero
		pointLights2[1].UseLight(5.0f, (1.0f, 1.0f, 1.0f),3.0f, (-70.0f + Espiralx, 4.5f + Espiralx, 43.0 + Espiralz),0.3f, 0.2f, 0.1f);
